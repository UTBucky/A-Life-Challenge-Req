...
class GridEnvironment:
    ...
    uses 2 different np arrays of size (size x size) for tracking occupancy and terrain - filled with 0s - dtype uint8 
    ...
    def __init__(self, size):
        ...
        """
        self._size = size
        self.terrain = np.zeros((size, size), dtype=np.uint8)  # 0 = land, 1 = water
    ...
    def add_organism(self, organism):
        ...
        organism: takes a custom class that contains genes and a method for moving
    ...
    def step(self):
        ...
        move_queue = sorted(self._organisms, key=lambda o: o.speed, reverse=True)
        ...
        # --- If we can avoid python for loop in future we should, come back to this ---
